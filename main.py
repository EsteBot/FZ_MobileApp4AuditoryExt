...
class MDScreen(FloatLayout):
    ...
    def mk_xl_file(self):
        try:
            ...
            sheet1['Y1'] = 'ITI+CS_17'
            sheet1['Z1'] = 'ITI+CS_18'
            sheet1['AA1'] = 'ITI+CS_19'
            sheet1['AB1'] = 'ITI+CS_20'
            sheet1['AC1'] = 'ITI+CS_21'
            sheet1['AD1'] = 'ITI+CS_22'
            sheet1['AE1'] = 'ITI+CS_23'
            sheet1['AF1'] = 'ITI+CS_24'
            sheet1['AG1'] = 'ITI+CS_25'
            sheet1['AH1'] = 'ITI_1'
            sheet1['AI1'] = 'ITI_2'
            sheet1['AJ1'] = 'ITI_3'
            sheet1['AK1'] = 'ITI_4'
            ...
            wb.save('//storage//emulated//0//Download//'+file_name+'.xlsx')
    ...
    def submit_data(self):
        ...
        file_name = self.ids.file_name.text
        wb = load_workbook('D:\FZnNOdb'+file_name+'.xlsx')
